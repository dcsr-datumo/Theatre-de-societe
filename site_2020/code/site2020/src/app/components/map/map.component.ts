...
export class MapComponent implements OnInit {
  ...
  markerClusterReady(markerCluster: MarkerClusterGroup) {
    ...
    // let thisIcon = icon({iconUrl: '/assets/img/marker-icon.png', shadowUrl: '/assets/img/marker-shadow.png'});
    const thisIcon = icon({iconUrl: '/assets/img/marker-icon.png'});
      ...
      map(
        (matches: PlaceCache[]) => matches.filter(
          (place: PlaceCache) => {
            ...
            const latLong = this.toLatLong(place);
